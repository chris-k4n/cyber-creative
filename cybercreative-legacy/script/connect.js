    (function () {
      ...
      // Submit
      //
      // NOTE: There is no backend wired up yet. Until this form posts to a
      // real endpoint (a serverless function, Formspree, EmailJS, etc.),
      // every submission below falls back to opening the visitor's email
      // client with a pre-filled mailto: so leads aren't silently lost.
      // Replace the mailto fallback with a real fetch() call once a
      ...
      document.getElementById('cfSubmit').addEventListener('click', function () {
        ...
        var mailtoUrl = 'mailto:connect@cybercreative.in'
          + '?subject=' + encodeURIComponent('New project inquiry from ' + fname + ' ' + lname)
