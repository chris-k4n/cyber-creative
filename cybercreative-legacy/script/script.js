...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('a[href]').forEach(link => {
    ...
    link.addEventListener('click', e => {
      // Let modifier-clicks / middle-clicks fall through to native
      // "open in new tab" behavior instead of hijacking navigation.
  ...
  /* ─────────────────────────────────────────────────────
     ...
     NOTE: The active click/keyboard/swipe wiring for the arc
     menu now lives entirely in services.js (it drives the
     #servicePanelFrame iframe). This file only handles the
     keyboard accessibility attributes so the slices remain
     tab-focusable; it deliberately does NOT attach its own
     click handlers here to avoid double-firing alongside
     services.js on services.html.
  ───────────────────────────────────────────────────── */
